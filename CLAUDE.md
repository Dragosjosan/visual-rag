...
This project is used as a Visual RAG for retriewing information from both text and images from .pdf files.
...
- Log every important step with `info`, and use the `debug` level for easy debugging/
...
- **When you find bugs, tech debt, or improvements** - suggest creating a backlog task but don't create it without asking first
